...
// implements a sort for the parcels
...
public abstract class Parcel : IComparable<Parcel>
{
    ...
    //precondition: None
    //Postconditons: when this < p2, gives negative, when this = p2, give zero, when this >p2, give positive
    public int CompareTo(Parcel p2)
    {
        if(p2 == null)//parcel is always higher price than null parcel
        {
            return 1;
        }
